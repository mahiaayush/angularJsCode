...
import { SessionObject } from '../project-utility/session-object';
...
export class Utils {
    ...
    public static xlsx = new ExcelUtil();
    ...
    public static formatDateData(startDate: any, dateFormat: string = 'MMM dd, yyyy'): string {
    ...
    public static navigateQueryValue(url: Array<any>, value) {
        return url.concat(value);
    }


    public static isSubscribed(sub: Subscription) {
