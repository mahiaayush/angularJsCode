...
export class CreateVendorComponent extends BaseComponent {
  ...
  handleLoadDataFromApi(name: string, data: any) {
    if (name === this.NAME_CREATE_VENDOR) {
      this.handleLoadDataFromApiCreateVendor(data);
    } else if (name === this.NAME_UPDATE_VENDOR) {
      this.handleLoadDataFromApiUpdateVendor(data);
    } else if (name === this.NAME_VIEW_VENDOR) {
      this.handleLoadDataFromApiViewVendor(data);
    } else if (name === this.NAME_COUNRTY_LIST) {
      this.handleLoadDataFromApiCountryList(data);
    } else if (name === this.NAME_RESOURCE_LIST) {
      this.handleLoadDataFromApiResourceList(data);
    } else if (name === this.NAME_ACTIVE_DEACTIVE_VENDOR) {
      this.handleLoadDataFromApiActiveDeactiveVendor(data);
    }
  }
  ...
  handleLoadDataFromApiCreateVendor(data) {
    this.state = true;
    this.hideLoader();
  ...
  handleLoadDataFromApiViewVendor(data) {
  ...
  handleLoadDataFromApiActiveDeactiveVendor(data) {
  ...
  handleLoadDataFromApiUpdateVendor(data) {
    this.state = true;
    this.hideLoader();
  ...
  handleLoadDataFromApiResourceList(data) {
